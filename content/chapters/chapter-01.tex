...
{
    % Place \usetable{} in between {}-braces and use \setlength\arrayrulewidth{}
    % to change the line width of the table.
    % To change specific table lines, see the comment in the /content/additionals/tables.tex file.
