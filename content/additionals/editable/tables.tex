...
% FORMAT: \savetable{<ID>}{<tableSetting(e.g. !ht)>}{<tabularSetting(e.g. |c|c|c|c|c|c|)}{<description>}{<content>}


\savetable{bsp}{h}{|c|c|c|c|c|c|}{Beispieltabelle}{
