...
% FORMAT: \savetable{<ID>}{<adjustSettings(e.g. center)>}{<tabularSetting(e.g. |c|c|c|c|c|c|)>}{<description>}{<content>}
% For <adjustSettings>: http://mirrors.ibiblio.org/CTAN/macros/latex/contrib/adjustbox/adjustbox.pdf
