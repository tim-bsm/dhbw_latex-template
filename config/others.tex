...
% Add a command for the plus to align in text, as it is always
% placed a bit too low by default
\newcommand{\plus}{%
...
% Change spacing of headings
% https://tex.stackexchange.com/a/223524
\RedeclareSectionCommand[
  %runin=false,
  afterindent=false,
  beforeskip=1\baselineskip,
  afterskip=.001\baselineskip]{subsubsection}
