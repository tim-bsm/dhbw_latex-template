...
\input{../config/settings_list.tex} % verfügbare Einstellungen
\input{../content/settings.tex} % lese Einstellungen

\input{../config/language/strings.tex} % verfügbare Strings
\input{../config/language/langs/\sprache.tex} % Übersetzung einlesen
...
\input{../config/additionals/images.tex} % externe Bilder einbinden
...
\input{../config/additionals/code.tex} % externe Listings einbinden
\listingsettings{}
