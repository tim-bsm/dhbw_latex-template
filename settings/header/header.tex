...
\input{../lang/strings.tex} % verfügbare Strings
\input{../lang/\sprache.tex} % Übersetzung einlesen
...
\newcommand{\defaultpagelayout}{
    ...
    \fancyhead[L]{
        \ifshowfirmenlogo
            \iflang{de}{
                \begin{textblock*}{188mm}(26mm,7mm)
                \includegraphics[height=1.4cm]{../images/mahle.png}
                \end{textblock*}
            }
            \iflang{en}{
                \begin{textblock*}{188mm}(26mm,7mm)
        ...
        \else
            \vspace{0.5cm}\small \langkopfz
        \fi
    }
    \fancyhead[R]{
        \ifshowdhbwlogo
            \iflang{de}{
                \begin{textblock*}{188mm}(-5mm,4mm)
                \includegraphics[height=1.8cm]{../images/dhbw.png}
                \end{textblock*}
            }
            \iflang{en}{
                \begin{textblock*}{188mm}(-5mm,4mm)
                    \includegraphics[height=1.8cm]{../images/dhbw_en.jpg}
                    \end{textblock*}
            }
        \fi
    }
    ...
    \fancyfoot[l]{\tiny \autor}
    \fancyfoot[c]{\tiny \arbeit}
}
...
\newcommand{\setpagestylehead}{
    \fancypagestyle{plain}{
        ...
        \fancyfoot[r]{\tiny \langseite\ \thepage\ \langseitevon\ \pageref*{endOfRomanNumbering}}
    }
    \pagestyle{plain}
    \pagenumbering{roman}
}
...
\newcommand{\setpagestylecontent}{
    \fancypagestyle{plain}{
        ...
        \fancyfoot[r]{\tiny \langseite\ \thepage\ \langseitevon\ \pageref*{endOfArabicNumbering}}    
    }
    \pagestyle{plain}
...
\newcommand{\setpagestylefoot}{
    \fancypagestyle{plain}{%
        ...
        \fancyfoot[r]{\tiny \langseite\ \thepage\ \langseitevon\ \pageref*{LastPage}}
    }
    \pagestyle{plain}
    \pagenumbering{Alph}
}
...
\newcommand\Watermark{%
    \put(0,0){%
        \parbox[b][\paperheight]{\paperwidth}{%
            \vfill
            \includepdf[scale=0.8,angle=50,pages={1},pagecommand={}]{ads/watermark/watermark.pdf}
            \vfill
        }
    }
}
